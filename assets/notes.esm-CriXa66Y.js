...
`+e.raw,s.text+=`
`+e.raw,this.inlineQueue[this.inlineQueue.length-1].src=s.text);else if(e=this.tokenizer.table(n))n=n.substring(e.raw.length),t.push(e);else if(e=this.tokenizer.lheading(n))n=n.substring(e.raw.length),t.push(e);else{if(a=n,this.options.extensions&&this.options.extensions.startBlock){let i=1/0;const l=n.slice(1);let c;this.options.extensions.startBlock.forEach(function(h){c=h.call({lexer:this},l),typeof c=="number"&&c>=0&&(i=Math.min(i,c))}),i<1/0&&i>=0&&(a=n.substring(0,i+1))}if(this.state.top&&(e=this.tokenizer.paragraph(a)))s=t[t.length-1],r&&s.type==="paragraph"?(s.raw+=`
`+e.raw,s.text+=`
...
`+e.raw,s.text+=`
`+e.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=s.text):t.push(e);else if(n){const i="Infinite loop on byte: "+n.charCodeAt(0);if(this.options.silent){console.error(i);break}throw new Error(i)}}return this.state.top=!0,t}inline(n,t=[]){return this.inlineQueue.push({src:n,tokens:t}),t}inlineTokens(n,t=[]){let e,s,a,r,i,l,c=n;if(this.tokens.links){const h=Object.keys(this.tokens.links);if(h.length>0)for(;(r=this.tokenizer.rules.inline.reflinkSearch.exec(c))!=null;)h.includes(r[0].slice(r[0].lastIndexOf("[")+1,-1))&&(c=c.slice(0,r.index)+"["+B("a",r[0].length-2)+"]"+c.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(r=this.tokenizer.rules.inline.blockSkip.exec(c))!=null;)c=c.slice(0,r.index)+"["+B("a",r[0].length-2)+"]"+c.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(r=this.tokenizer.rules.inline.escapedEmSt.exec(c))!=null;)c=c.slice(0,r.index+r[0].length-2)+"++"+c.slice(this.tokenizer.rules.inline.escapedEmSt.lastIndex),this.tokenizer.rules.inline.escapedEmSt.lastIndex--;for(;n;)if(i||(l=""),i=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some(h=>!!(e=h.call({lexer:this},n,t))&&(n=n.substring(e.raw.length),t.push(e),!0))))if(e=this.tokenizer.escape(n))n=n.substring(e.raw.length),t.push(e);else if(e=this.tokenizer.tag(n))n=n.substring(e.raw.length),s=t[t.length-1],s&&e.type==="text"&&s.type==="text"?(s.raw+=e.raw,s.text+=e.text):t.push(e);else if(e=this.tokenizer.link(n))n=n.substring(e.raw.length),t.push(e);else if(e=this.tokenizer.reflink(n,this.tokens.links))n=n.substring(e.raw.length),s=t[t.length-1],s&&e.type==="text"&&s.type==="text"?(s.raw+=e.raw,s.text+=e.text):t.push(e);else if(e=this.tokenizer.emStrong(n,c,l))n=n.substring(e.raw.length),t.push(e);else if(e=this.tokenizer.codespan(n))n=n.substring(e.raw.length),t.push(e);else if(e=this.tokenizer.br(n))n=n.substring(e.raw.length),t.push(e);else if(e=this.tokenizer.del(n))n=n.substring(e.raw.length),t.push(e);else if(e=this.tokenizer.autolink(n,j))n=n.substring(e.raw.length),t.push(e);else if(this.state.inLink||!(e=this.tokenizer.url(n,j))){if(a=n,this.options.extensions&&this.options.extensions.startInline){let h=1/0;const o=n.slice(1);let u;this.options.extensions.startInline.forEach(function(w){u=w.call({lexer:this},o),typeof u=="number"&&u>=0&&(h=Math.min(h,u))}),h<1/0&&h>=0&&(a=n.substring(0,h+1))}if(e=this.tokenizer.inlineText(a,pt))n=n.substring(e.raw.length),e.raw.slice(-1)!=="_"&&(l=e.raw.slice(-1)),i=!0,s=t[t.length-1],s&&s.type==="text"?(s.raw+=e.raw,s.text+=e.text):t.push(e);else if(n){const h="Infinite loop on byte: "+n.charCodeAt(0);if(this.options.silent){console.error(h);break}throw new Error(h)}}else n=n.substring(e.raw.length),t.push(e);return t}}class O{constructor(n){this.options=n||E}code(n,t,e){const s=(t||"").match(/\S*/)[0];if(this.options.highlight){const a=this.options.highlight(n,s);a!=null&&a!==n&&(e=!0,n=a)}return n=n.replace(/\n$/,"")+`
...
`}strong(n){return`<strong>${n}</strong>`}em(n){return`<em>${n}</em>`}codespan(n){return`<code>${n}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(n){return`<del>${n}</del>`}link(n,t,e){if((n=Z(this.options.sanitize,this.options.baseUrl,n))===null)return e;let s='<a href="'+n+'"';return t&&(s+=' title="'+t+'"'),s+=">"+e+"</a>",s}image(n,t,e){if((n=Z(this.options.sanitize,this.options.baseUrl,n))===null)return e;let s=`<img src="${n}" alt="${e}"`;return t&&(s+=` title="${t}"`),s+=this.options.xhtml?"/>":">",s}text(n){return n}}class V{strong(n){return n}em(n){return n}codespan(n){return n}del(n){return n}html(n){return n}text(n){return n}link(n,t,e){return""+e}image(n,t,e){return""+e}br(){return""}}class F{constructor(){this.seen={}}serialize(n){return n.toLowerCase().trim().replace(/<[!\/a-z].*?>/gi,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(n,t){let e=n,s=0;if(this.seen.hasOwnProperty(e)){s=this.seen[n];do s++,e=n+"-"+s;while(this.seen.hasOwnProperty(e))}return t||(this.seen[n]=s,this.seen[e]=0),e}slug(n,t={}){const e=this.serialize(n);return this.getNextSafeSlug(e,t.dryrun)}}class ${constructor(n){this.options=n||E,this.options.renderer=this.options.renderer||new O,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new V,this.slugger=new F}static parse(n,t){return new $(t).parse(n)}static parseInline(n,t){return new $(t).parseInline(n)}parse(n,t=!0){let e,s,a,r,i,l,c,h,o,u,w,S,y,T,f,A,L,v,_,x="";const R=n.length;for(e=0;e<R;e++)if(u=n[e],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[u.type]&&(_=this.options.extensions.renderers[u.type].call({parser:this},u),_!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(u.type)))x+=_||"";else switch(u.type){case"space":continue;case"hr":x+=this.renderer.hr();continue;case"heading":x+=this.renderer.heading(this.parseInline(u.tokens),u.depth,K(this.parseInline(u.tokens,this.textRenderer)),this.slugger);continue;case"code":x+=this.renderer.code(u.text,u.lang,u.escaped);continue;case"table":for(h="",c="",r=u.header.length,s=0;s<r;s++)c+=this.renderer.tablecell(this.parseInline(u.header[s].tokens),{header:!0,align:u.align[s]});for(h+=this.renderer.tablerow(c),o="",r=u.rows.length,s=0;s<r;s++){for(l=u.rows[s],c="",i=l.length,a=0;a<i;a++)c+=this.renderer.tablecell(this.parseInline(l[a].tokens),{header:!1,align:u.align[a]});o+=this.renderer.tablerow(c)}x+=this.renderer.table(h,o);continue;case"blockquote":o=this.parse(u.tokens),x+=this.renderer.blockquote(o);continue;case"list":for(w=u.ordered,S=u.start,y=u.loose,r=u.items.length,o="",s=0;s<r;s++)f=u.items[s],A=f.checked,L=f.task,T="",f.task&&(v=this.renderer.checkbox(A),y?f.tokens.length>0&&f.tokens[0].type==="paragraph"?(f.tokens[0].text=v+" "+f.tokens[0].text,f.tokens[0].tokens&&f.tokens[0].tokens.length>0&&f.tokens[0].tokens[0].type==="text"&&(f.tokens[0].tokens[0].text=v+" "+f.tokens[0].tokens[0].text)):f.tokens.unshift({type:"text",text:v}):T+=v),T+=this.parse(f.tokens,y),o+=this.renderer.listitem(T,L,A);x+=this.renderer.list(o,w,S);continue;case"html":x+=this.renderer.html(u.text);continue;case"paragraph":x+=this.renderer.paragraph(this.parseInline(u.tokens));continue;case"text":for(o=u.tokens?this.parseInline(u.tokens):u.text;e+1<R&&n[e+1].type==="text";)u=n[++e],o+=`
`+(u.tokens?this.parseInline(u.tokens):u.text);x+=t?this.renderer.paragraph(o):o;continue;default:{const N='Token with "'+u.type+'" type was not found.';if(this.options.silent)return void console.error(N);throw new Error(N)}}return x}parseInline(n,t){t=t||this.renderer;let e,s,a,r="";const i=n.length;for(e=0;e<i;e++)if(s=n[e],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[s.type]&&(a=this.options.extensions.renderers[s.type].call({parser:this},s),a!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(s.type)))r+=a||"";else switch(s.type){case"escape":case"text":r+=t.text(s.text);break;case"html":r+=t.html(s.text);break;case"link":r+=t.link(s.href,s.title,this.parseInline(s.tokens,t));break;case"image":r+=t.image(s.href,s.title,s.text);break;case"strong":r+=t.strong(this.parseInline(s.tokens,t));break;case"em":r+=t.em(this.parseInline(s.tokens,t));break;case"codespan":r+=t.codespan(s.text);break;case"br":r+=t.br();break;case"del":r+=t.del(this.parseInline(s.tokens,t));break;default:{const l='Token with "'+s.type+'" type was not found.';if(this.options.silent)return void console.error(l);throw new Error(l)}}return r}}class C{constructor(n){this.options=n||E}preprocess(n){return n}postprocess(n){return n}}D(C,"passThroughHooks",new Set(["preprocess","postprocess"]));function Y(d,n){return(t,e,s)=>{typeof e=="function"&&(s=e,e=null);const a={...e},r=function(i,l,c){return h=>{if(h.message+=`
Please report this to https://github.com/markedjs/marked.`,i){const o="<p>An error occurred:</p><pre>"+b(h.message+"",!0)+"</pre>";return l?Promise.resolve(o):c?void c(null,o):o}if(l)return Promise.reject(h);if(!c)throw h;c(h)}}((e={...g.defaults,...a}).silent,e.async,s);if(t==null)return r(new Error("marked(): input parameter is undefined or null"));if(typeof t!="string")return r(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(t)+", string expected"));if(function(i){i&&i.sanitize&&!i.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")}(e),e.hooks&&(e.hooks.options=e),s){const i=e.highlight;let l;try{e.hooks&&(t=e.hooks.preprocess(t)),l=d(t,e)}catch(o){return r(o)}const c=function(o){let u;if(!o)try{e.walkTokens&&g.walkTokens(l,e.walkTokens),u=n(l,e),e.hooks&&(u=e.hooks.postprocess(u))}catch(w){o=w}return e.highlight=i,o?r(o):s(null,u)};if(!i||i.length<3||(delete e.highlight,!l.length))return c();let h=0;return g.walkTokens(l,function(o){o.type==="code"&&(h++,setTimeout(()=>{i(o.text,o.lang,function(u,w){if(u)return c(u);w!=null&&w!==o.text&&(o.text=w,o.escaped=!0),h--,h===0&&c()})},0))}),void(h===0&&c())}if(e.async)return Promise.resolve(e.hooks?e.hooks.preprocess(t):t).then(i=>d(i,e)).then(i=>e.walkTokens?Promise.all(g.walkTokens(i,e.walkTokens)).then(()=>i):i).then(i=>n(i,e)).then(i=>e.hooks?e.hooks.postprocess(i):i).catch(r);try{e.hooks&&(t=e.hooks.preprocess(t));const i=d(t,e);e.walkTokens&&g.walkTokens(i,e.walkTokens);let l=n(i,e);return e.hooks&&(l=e.hooks.postprocess(l)),l}catch(i){return r(i)}}}function g(d,n,t){return Y(z.lex,$.parse)(d,n,t)}g.options=g.setOptions=function(d){var n;return g.defaults={...g.defaults,...d},n=g.defaults,E=n,g},g.getDefaults=tt,g.defaults=E,g.use=function(...d){const n=g.defaults.extensions||{renderers:{},childTokens:{}};d.forEach(t=>{const e={...t};if(e.async=g.defaults.async||e.async||!1,t.extensions&&(t.extensions.forEach(s=>{if(!s.name)throw new Error("extension name required");if(s.renderer){const a=n.renderers[s.name];n.renderers[s.name]=a?function(...r){let i=s.renderer.apply(this,r);return i===!1&&(i=a.apply(this,r)),i}:s.renderer}if(s.tokenizer){if(!s.level||s.level!=="block"&&s.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");n[s.level]?n[s.level].unshift(s.tokenizer):n[s.level]=[s.tokenizer],s.start&&(s.level==="block"?n.startBlock?n.startBlock.push(s.start):n.startBlock=[s.start]:s.level==="inline"&&(n.startInline?n.startInline.push(s.start):n.startInline=[s.start]))}s.childTokens&&(n.childTokens[s.name]=s.childTokens)}),e.extensions=n),t.renderer){const s=g.defaults.renderer||new O;for(const a in t.renderer){const r=s[a];s[a]=(...i)=>{let l=t.renderer[a].apply(s,i);return l===!1&&(l=r.apply(s,i)),l}}e.renderer=s}if(t.tokenizer){const s=g.defaults.tokenizer||new q;for(const a in t.tokenizer){const r=s[a];s[a]=(...i)=>{let l=t.tokenizer[a].apply(s,i);return l===!1&&(l=r.apply(s,i)),l}}e.tokenizer=s}if(t.hooks){const s=g.defaults.hooks||new C;for(const a in t.hooks){const r=s[a];C.passThroughHooks.has(a)?s[a]=i=>{if(g.defaults.async)return Promise.resolve(t.hooks[a].call(s,i)).then(c=>r.call(s,c));const l=t.hooks[a].call(s,i);return r.call(s,l)}:s[a]=(...i)=>{let l=t.hooks[a].apply(s,i);return l===!1&&(l=r.apply(s,i)),l}}e.hooks=s}if(t.walkTokens){const s=g.defaults.walkTokens;e.walkTokens=function(a){let r=[];return r.push(t.walkTokens.call(this,a)),s&&(r=r.concat(s.call(this,a))),r}}g.setOptions(e)})},g.walkTokens=function(d,n){let t=[];for(const e of d)switch(t=t.concat(n.call(g,e)),e.type){case"table":for(const s of e.header)t=t.concat(g.walkTokens(s.tokens,n));for(const s of e.rows)for(const a of s)t=t.concat(g.walkTokens(a.tokens,n));break;case"list":t=t.concat(g.walkTokens(e.items,n));break;default:g.defaults.extensions&&g.defaults.extensions.childTokens&&g.defaults.extensions.childTokens[e.type]?g.defaults.extensions.childTokens[e.type].forEach(function(s){t=t.concat(g.walkTokens(e[s],n))}):e.tokens&&(t=t.concat(g.walkTokens(e.tokens,n)))}return t},g.parseInline=Y(z.lexInline,$.parseInline),g.Parser=$,g.parser=$.parse,g.Renderer=O,g.TextRenderer=V,g.Lexer=z,g.lexer=z.lex,g.Tokenizer=q,g.Slugger=F,g.Hooks=C,g.parse=g,g.options,g.setOptions,g.use,g.walkTokens,g.parseInline,$.parse,z.lex;const ht=()=>{let d,n,t=null;function e(){if(t&&!t.closed)t.focus();else{if(t=window.open("about:blank","reveal.js - Notes","width=1100,height=700"),t.marked=g,t.document.write(`<!--
...
</html>`),!t)return void alert("Speaker view popup failed to open. Please make sure popups are allowed and reopen the speaker view.");(function(){const i=n.getConfig().url,l=typeof i=="string"?i:window.location.protocol+"//"+window.location.host+window.location.pathname+window.location.search;d=setInterval(function(){t.postMessage(JSON.stringify({namespace:"reveal-notes",type:"connect",state:n.getState(),url:l}),"*")},500),window.addEventListener("message",a)})()}}function s(i){let l=n.getCurrentSlide(),c=l.querySelectorAll("aside.notes"),h=l.querySelector(".current-fragment"),o={namespace:"reveal-notes",type:"state",notes:"",markdown:!1,whitespace:"normal",state:n.getState()};if(l.hasAttribute("data-notes")&&(o.notes=l.getAttribute("data-notes"),o.whitespace="pre-wrap"),h){let u=h.querySelector("aside.notes");u?(o.notes=u.innerHTML,o.markdown=typeof u.getAttribute("data-markdown")=="string",c=null):h.hasAttribute("data-notes")&&(o.notes=h.getAttribute("data-notes"),o.whitespace="pre-wrap",c=null)}c&&c.length&&(c=Array.from(c).filter(u=>u.closest(".fragment")===null),o.notes=c.map(u=>u.innerHTML).join(`
`),o.markdown=c[0]&&typeof c[0].getAttribute("data-markdown")=="string"),t.postMessage(JSON.stringify(o),"*")}function a(i){if(function(l){try{return window.location.origin===l.source.location.origin}catch{return!1}}(i))try{let l=JSON.parse(i.data);l&&l.namespace==="reveal-notes"&&l.type==="connected"?(clearInterval(d),r()):l&&l.namespace==="reveal-notes"&&l.type==="call"&&function(c,h,o){let u=n[c].apply(n,h);t.postMessage(JSON.stringify({namespace:"reveal-notes",type:"return",result:u,callId:o}),"*")}(l.methodName,l.arguments,l.callId)}catch{}}function r(){n.on("slidechanged",s),n.on("fragmentshown",s),n.on("fragmenthidden",s),n.on("overviewhidden",s),n.on("overviewshown",s),n.on("paused",s),n.on("resumed",s),s()}return{id:"notes",init:function(i){n=i,/receiver/i.test(window.location.search)||(window.location.search.match(/(\?|\&)notes/gi)!==null?e():window.addEventListener("message",l=>{if(!t&&typeof l.data=="string"){let h;try{h=JSON.parse(l.data)}catch{}h&&h.namespace==="reveal-notes"&&h.type==="heartbeat"&&(c=l.source,t&&!t.closed?t.focus():(t=c,window.addEventListener("message",a),r()))}var c}),n.addKeyBinding({keyCode:83,key:"S",description:"Speaker notes view"},function(){e()}))},open:e}};export{ht as default};
