import{af as F,aQ as V,O as c,aa as q,aR as O,U as E,N as Q,aS as r,Q as v,ac as N,a1 as K,ag as j,_ as U,aT as P,ae as C,am as i}from"./app-CLYCBq-A.js";import{M as Z,a as H,b as z,d as J,c as W,e as X,f as Y,v as ee,g as te,h as ae,i as ne,k as se,j as le,l as re,m as oe,n as ie,o as ue,p as pe,q as de,s as ce,t as me,w as _e,u as ye}from"./vidstack-CdHBcYUs-oKyOYpBt.js";import{L as $e,x as n,o as S}from"./vidstack-rsZGrNIW-Cp0HsRb4.js";import{$ as l,S as be,L as fe,I as ve}from"./vidstack-DDr92MCR-z7Oe63WN.js";import{MediaPosterElement as ge}from"./vidstack-CyVF_YzU-GVEIIAbw.js";class we extends fe{async Pf(){const t=(await U(()=>import("./vidstack-DXxIKXmd-Dge3KT8k.js"),[])).icons,a={};for(const s of Object.keys(t))a[s]=ve({name:s,paths:t[s],viewBox:"0 0 18 18"});return a}}function g(e,t){var a;return((a=e())==null?void 0:a[t])??t}function he(){return xe()}function Me(){const e=c(),{load:t}=e.$props,{canLoad:a}=e.$state;return Q(()=>t()==="play"&&!a())()?[B(),x()]:[Te(),ke(),x(),Ee(),Qe(),Ne()]}function B(){const e=c(),{translations:t}=r(),{title:a}=e.$state,s=l(()=>`${g(t,"Play")}, ${a()}`);return n`
    <media-play-button
