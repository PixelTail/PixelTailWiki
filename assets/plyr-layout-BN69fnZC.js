import{af as V,aQ as F,O as c,ac as q,aR as O,V as E,_ as Q,N,aS as r,Q as v,ag as K,a1 as j,a9 as Z,aT as P,aa as C,am as i}from"./app-DinApzDR.js";import{M as H,a as U,b as z,d as J,c as W,e as X,f as Y,v as ee,g as te,h as ae,i as ne,k as se,j as le,l as re,m as oe,n as ie,o as ue,p as pe,q as de,s as ce,t as me,w as _e,u as ye}from"./vidstack-CdHBcYUs-DB0-eK14.js";import{L as $e,x as n,o as S}from"./vidstack-rsZGrNIW-BXbX7Ib4.js";import{S as be,$ as l,L as fe,I as ve}from"./vidstack-DDr92MCR-CYWnl0Xl.js";import{MediaPosterElement as ge}from"./vidstack-CyVF_YzU-Cz3rQO3J.js";class we extends fe{async Pf(){const t=(await Q(()=>import("./vidstack-DXxIKXmd-Dge3KT8k.js"),[])).icons,a={};for(const s of Object.keys(t))a[s]=ve({name:s,paths:t[s],viewBox:"0 0 18 18"});return a}}function g(e,t){var a;return((a=e())==null?void 0:a[t])??t}function he(){return xe()}function Me(){const e=c(),{load:t}=e.$props,{canLoad:a}=e.$state;return N(()=>t()==="play"&&!a())()?[B(),x()]:[Te(),ke(),x(),Ee(),Qe(),Ne()]}function B(){const e=c(),{translations:t}=r(),{title:a}=e.$state,s=l(()=>`${g(t,"Play")}, ${a()}`);return n`
    <media-play-button
  ...
  `}function qe(){const e=c(),{translations:t,invertTime:a,toggleTime:s,displayDuration:u}=r(),m=v(Z(a));function $(d){!s()||u()||P(d)&&!C(d)||m.set(y=>!y)}function _(){return l(()=>u()?R():null)}return l(()=>{const{streamType:d}=e.$state,y=o(t,"LIVE"),b=o(t,"Current time"),h=l(()=>!u()&&m());return d()==="live"||d()==="ll-live"?n`
          <media-live-button
    ...
    <media-time
      ...
      aria-label=${t}
    ></media-time>
  `}function Oe(){return l(()=>{const e=c(),{translations:t,download:a}=r(),{title:s,source:u}=e.$state,m=u(),$=a(),_=j({title:s(),src:m,download:$}),d=o(t,"Download");return _?n`
          <a
            class="plyr__controls__item plyr__control"
        ...
        `:null})}function Qe(){return l(()=>{const{clickToPlay:e,clickToFullscreen:t}=r();return[e()?n`
          ...
          `:null,t()?n`
            ...
            ></media-gesture>
          `:null]})}function Ne(){const e=c(),t=v(void 0),a=l(()=>{var s;return S((s=t())==null?void 0:s.text)});return E(()=>{const s=e.$state.textTrack();if(!s)return;function u(){t.set(s==null?void 0:s.activeCues[0])}return u(),K(s,"cue-change",u)}),n`
